...
function bundleInstall(){
  ...
  if (this.options.use_docker) {
    const isSilicon = os.cpus()[0].model.includes("Apple");
    docker_name = 'public.ecr.aws/sam/build-'+this.serverless.service.provider.runtime+':latest-'+(isSilicon ? 'arm64' : 'x86_64');
